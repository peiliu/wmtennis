...
class MvcFileIncluder {
    ...
    function __construct() {
        ...
        $this->plugin_app_paths = array(WMTENNIS_PLUGIN_PATH.'app/', WMTENNIS_PLUGIN_PATH.'app/controllers/', WMTENNIS_PLUGIN_PATH.'app/models/' );
    ...
    public function require_core_file($filepath) {
        ...
        if ($this->include_core_file('helpers/'.$filepath)) {
            return true;
        }
